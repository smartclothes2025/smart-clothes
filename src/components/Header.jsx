  ...
  return (
    <header className="px-4 pt-6 pb-3 flex items-center justify-between">
      <div className="flex items-center gap-2">
        <img src="/public/穿搭醬logo.png" alt="穿搭醬 Logo" className="h-8 w-auto" />
        <h1 className="text-2xl font-extrabold tracking-tight text-gray-900">{title}</h1>
      </div>
      <div className="flex items-center gap-3">
        <button className="p-2 bg-white rounded-lg shadow-sm"><Search className="w-5 h-5 text-gray-600" /></button>
